...
**Status:** PRD 1.5, API 1.6, Technical Design 1.5, Data Model 1.5, Plan 1.4, constitution 1.1.
...
| `../changes/_archive/` | the seven folded Delta Specs, kept as the record of what changed and why |
