...
- Specs at PRD 1.7 / API 1.8 / Tech 1.8 / Data Model 1.6 / Plan 1.4, constitution 1.2. Twelve deltas are archived under `changes/_archive/` and none is pending; the last of them, `2026-09-pane-attention-state`, adds `unknown` to `rollup_state` and records that F0 has no producer of a pane's attention state.
