...
- Specs at PRD 1.8 / API 1.10 / Tech 1.8 / Data Model 1.6 / Plan 1.4, constitution 1.2. Fifteen deltas are archived under `changes/_archive/` and **none is pending**: `2026-09-capability-degradation` was ratified on 2026-09-20 and moves the `capabilities` derivation onto what a build serves, so an unserved method keeps its name and `NOT_IMPLEMENTED` becomes reachable.
