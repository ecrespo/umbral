...
is pending ratification ([`changes/2026-09-pane-fields-and-api-imports`](changes/2026-09-pane-fields-and-api-imports/)). Alongside the full SDD package (constitution, PRD with EARS, API, technical
