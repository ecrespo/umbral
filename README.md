...
is pending ratification ([`changes/2026-09-schema-and-degradation-corrections`](changes/2026-09-schema-and-degradation-corrections/)). Alongside the full SDD package (constitution, PRD with EARS, API, technical
